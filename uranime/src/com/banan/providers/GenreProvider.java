...
public class GenreProvider extends ContentProvider{
		...
		private static final String TAG = GenreProvider.class.getName();
		
		private static final UriMatcher sURIMatcher = new UriMatcher(
		        UriMatcher.NO_MATCH);
		
		public static final int GENRE = 100;
		public static final int GENRE_ID = 110;
		private static final String AUTHORITY = "com.banan.providers.GenreProvider";
		private static final String MOVIE_BASE_PATH = "episodes";
		
		private DBHelper db;

		static {
		    sURIMatcher.addURI(AUTHORITY, MOVIE_BASE_PATH, GENRE);
		    sURIMatcher.addURI(AUTHORITY, MOVIE_BASE_PATH + "/#", GENRE_ID);
		}
		...
		public int delete(Uri uri, String selection, String[] selectionArgs)
		{
	        ...
	        switch (uriType) {
	        case GENRE:
	            rowsAffected = sqlDB.delete(DBHelper.GENRE_TABLE,
		...
		public Uri insert(Uri uri, ContentValues values)
		{
	        ...
	        try {
	            long newID = sqlDB.insertOrThrow(DBHelper.GENRE_TABLE,
	                    null, values);
	            if (newID > 0) {
				...
				String sortOrder)
		{
			...
			queryBuilder.setTables(DBHelper.GENRE_TABLE);
		...
		public int update(Uri uri, ContentValues values, String whereClause, String[] whereArgs)
		{
			...
			int rowsAffected = sqlDB.update(DBHelper.GENRE_TABLE, values, whereClause, whereArgs);
			getContext().getContentResolver().notifyChange(uri, null);
