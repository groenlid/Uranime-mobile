...
public class EpisodeProvider extends ContentProvider{
		...
		private static final String TAG = EpisodeProvider.class.getName();
		
		private static final UriMatcher sURIMatcher = new UriMatcher(
		        UriMatcher.NO_MATCH);
		
		public static final int EPISODE = 100;
		public static final int EPISODE_ID = 110;
		private static final String AUTHORITY = "com.banan.providers.EpisodeProvider";
		private static final String MOVIE_BASE_PATH = "episodes";
		
		private DBHelper db;

		static {
		    sURIMatcher.addURI(AUTHORITY, MOVIE_BASE_PATH, EPISODE);
		    sURIMatcher.addURI(AUTHORITY, MOVIE_BASE_PATH + "/#", EPISODE_ID);
		}
		...
		public int delete(Uri uri, String selection, String[] selectionArgs)
		{
	        ...
	        switch (uriType) {
	        case EPISODE:
	            rowsAffected = sqlDB.delete(DBHelper.EPISODE_TABLE,
		...
		public Uri insert(Uri uri, ContentValues values)
		{
	        ...
	        try {
	            long newID = sqlDB.insertOrThrow(DBHelper.EPISODE_TABLE,
	                    null, values);
	            if (newID > 0) {
				...
				String sortOrder)
		{
			...
			queryBuilder.setTables(DBHelper.EPISODE_TABLE);
		...
		public int update(Uri uri, ContentValues values, String whereClause, String[] whereArgs)
		{
			...
			int rowsAffected = sqlDB.update(DBHelper.EPISODE_TABLE, values, whereClause, whereArgs);
			getContext().getContentResolver().notifyChange(uri, null);
