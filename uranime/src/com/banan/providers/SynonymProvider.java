...
public class SynonymProvider extends ContentProvider{
		...
		private static final String TAG = SynonymProvider.class.getName();
		
		private static final UriMatcher sURIMatcher = new UriMatcher(
		        UriMatcher.NO_MATCH);
		
		public static final int SYNONYM = 100;
		public static final int SYNONYM_ID = 110;
		private static final String AUTHORITY = "com.banan.providers.SynonymProvider";
		private static final String MOVIE_BASE_PATH = "episodes";
		
		private DBHelper db;

		static {
		    sURIMatcher.addURI(AUTHORITY, MOVIE_BASE_PATH, SYNONYM);
		    sURIMatcher.addURI(AUTHORITY, MOVIE_BASE_PATH + "/#", SYNONYM_ID);
		}
		...
		public int delete(Uri uri, String selection, String[] selectionArgs)
		{
	        ...
	        switch (uriType) {
	        case SYNONYM:
	            rowsAffected = sqlDB.delete(DBHelper.SYNONYM_TABLE,
		...
		public Uri insert(Uri uri, ContentValues values)
		{
	        ...
	        try {
	            long newID = sqlDB.insertOrThrow(DBHelper.SYNONYM_TABLE,
	                    null, values);
	            if (newID > 0) {
				...
				String sortOrder)
		{
			...
			queryBuilder.setTables(DBHelper.SYNONYM_TABLE);
		...
		public int update(Uri uri, ContentValues values, String whereClause, String[] whereArgs)
		{
			...
			int rowsAffected = sqlDB.update(DBHelper.SYNONYM_TABLE, values, whereClause, whereArgs);
			getContext().getContentResolver().notifyChange(uri, null);
